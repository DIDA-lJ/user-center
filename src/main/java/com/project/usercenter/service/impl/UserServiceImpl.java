package com.project.usercenter.service.impl;
...
import com.project.usercenter.mapper.UserMapper;
import com.project.usercenter.contant.UserConstant;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode) {
        ...
        if (planetCode.length() > 6) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "用户编号太长");
        }
        //账户不能重复
        ...
        if (!saveResult) {
            throw new BusinessException(ErrorCode.SAVE_ERROR, "账号数据保存异常，请稍后重试!");
        }
        return user.getId();
    }
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if (user == null) {
            ...
            throw new BusinessException(ErrorCode.NO_LOGIN, "用户不存在,请让其稍后重试!");
        }
        //3.用户信息脱敏
    ...
    public User getSafetyUser(User originUser) {
        if (originUser == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "用户数据为空，脱敏异常");
        }
